...
export const TutorialContent: React.FC<TutorialContentProps> = ({
  ...
  return (
    <div
      className={`grid md:grid-cols-2 gap-0 h-full bg-white/60 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden ${className}`}
    >
      <div className="bg-gray-50/50 p-8 flex items-center justify-center min-h-[300px] md:min-h-auto">
        <div className="w-full aspect-video bg-white rounded-2xl shadow-lg overflow-hidden border-4 border-gray-200/50 relative flex items-center justify-center">
          <img
            src={LogoPlaceholder}
      ...
      <div className="p-8 md:p-12 flex flex-col">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-3 bg-[#0047AB]/10 rounded-full text-sm text-[#0047AB] self-start mb-4 md:mb-0">
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-normal text-brand-indigo mb-4 font-ananda">
              How It Works
            </h2>
